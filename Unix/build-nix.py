                        ...
                        if result_copy == 0:
                            ...
                            if os_name == "Linux":
                                ...
                                for file in os.listdir(dir_build +"/lib/postgresql"):  
                                    ...
                                    os.system('cd '+ dir_build +'/lib/postgresql && install_name_tool -change "/Users/2ndquadrant/pl-languages/Tcl-8.6/lib/libtcl8.6.dylib" "@executable_path/../../pl-languages/Tcl-8.6/lib/libtcl8.6.dylib" "./'+ file +'" >> '+ dir_logs +"/postgreSQL_postgresql_rpath.log 2>&1")
